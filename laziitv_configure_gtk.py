# -----------------------------------
#     laziitv_configure_gtk.py
#     Author: Andrew Shay
#     Created: June 10 2012
#     Description: Runs the GUI component for LaziiTV
# -----------------------------------
...
def find_port():
    """
    Finds availble port for Tornado / Flask

    Returns:
    app_port -- Int. The available port
    """
...
class PyGTKExample:
    ...
    def __init__(self):
        ...
        self.mainWindow.set_title('LaziiTV Configure')
